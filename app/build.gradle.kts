...
dependencies {
    ...
    // Unica razon: mirar si llego una asignacion nueva con el app cerrado. Se usa
    // WorkManager y no JobScheduler a pelo porque este telefono es Samsung, y su gestor
    // de bateria cancela trabajos que WorkManager sabe reencolar.
