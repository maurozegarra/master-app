...
import com.athletic.PlayerBus
import com.athletic.PlayerCommand
import com.athletic.PlayerSnapshot
...
class WorkoutPlayerService : Service() {
    ...
    companion object {
        ...
        private const val ACTION_START = "com.athletic.player.START"
        private const val ACTION_PAUSE = "com.athletic.player.PAUSE"
